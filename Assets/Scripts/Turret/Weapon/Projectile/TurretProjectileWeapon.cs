...
namespace Turret.Weapon.Projectile
{
    public class TurretProjectileWeapon : ITurretWeapon
    {
        ...
        public TurretProjectileWeapon(TurretProjectileWeaponAsset asset, TurretView view)
        {
            ...
            m_NodesInCircle = Game.Player.Grid.GetNodesInCircle(m_View.transform.position, m_MaxDistance);
        }
        ...
        public void TickShoot()
        {
            ...
            EnemyData closestEnemyData = 
                EnemySearch.GetClosestEnemy(m_View.transform.position, m_MaxDistance, m_NodesInCircle);
